...
The user modified `spec/orders/features/cancellation.feature` to allow cancellation up to 1 hour after dispatch (previously: no cancellation after dispatch).
...
<!-- Started: 2026-03-15 -->
<!-- Scope: spec/orders/features/cancellation.feature -->

## Points Observed

- [P1] orders/features/cancellation.feature:14 — Orders can be cancelled up to 1 hour after dispatch (CHANGED)
- [P2] orders/features/cancellation.feature:22 — Cancellation after 1-hour window is rejected (CHANGED)
- [P3] orders/decisions/BDR-0001.md — No cancellation after dispatch (accepted)
- [P4] shipping/features/dispatch.feature:10 — Dispatch triggers carrier pickup immediately
- [P5] orders/features/cancellation.feature:30 — Refund is issued on cancellation (CHANGED — now includes post-dispatch partial refund)
...
> - Cascade check: `shipping/features/dispatch.feature` uses "Dispatched" but doesn't claim irreversibility in its scenarios — no cascade needed.
>
...
A full scan of `spec/` with three domains: orders, shipping, authentication.
...
- [P3] orders/features/cancellation.feature:14 — Orders can be cancelled before dispatch
- [P4] orders/features/cancellation.feature:28 — Refund issued within 5 business days
- [P5] shipping/features/returns.feature:15 — Returns accepted within 30 days; refund within 3 business days
- [P6] authentication/features/login.feature:10 — Members can access order history
- [P7] authentication/features/login.feature:18 — Churned subscribers retain read-only access for 90 days
- [P8] orders/features/loyalty.feature:12 — Members earn 1 point per dollar spent
- [P9] orders/features/loyalty.feature:20 — Churned subscribers lose all points immediately
- [P10] orders/decisions/BDR-0002.md — Partial cancellation not supported (deferred)
- [P11] orders/features/cancellation.feature:35 — Scenario: "Customer cancels one item from multi-item order"
...
>
> - `cancellation.feature:28` says refunds take 5 business days
> - `returns.feature:15` says refunds take 3 business days
>
> Options:
...
>
> - `cancellation.feature:35` has a scenario for cancelling one item from a multi-item order
> - `BDR-0002` explicitly deferred partial cancellation
>
> Options:
...
>
> - `loyalty.feature:20` forfeits points immediately on churn
> - `login.feature:18` retains read-only access for 90 days
>
